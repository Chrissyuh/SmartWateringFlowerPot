...
| `L1` | Buck inductor | `2.2uH shielded >=3A Isat`, `Inductor_SMD:L_Bourns_SRN6045TA` | Treat as a footprint/current-class default; confirm final stocked part current, DCR, and height. |
...
- Place `U2`, `C1`, `C2`, `C3`, and `L1` as a tight buck-regulator cluster before routing other signals.
